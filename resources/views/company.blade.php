...
@section('company')
    ...
    <div id="company" class="container">
        ...
        <!--<br>
        <h6 class="center-align" style="font-style: italic;">
            "InfiniteDATA finds underlying opportunities and helps clients to optimize their information delivery processes to support business decisions better."
        </h6>-->
        <br>
        <div class="row">
        ...
        <div class="row">
            <div class="grid-example col s12 m4 l7">
                <div class="card-panel grey lighten-1">
                    <span class="black-text">InfiniteDATA was founded in 2010 in Warsaw, Poland by team of professionals with average +15 years of Information Delivery experience.
            ...
            <div class="grid-example col s12 m4 l5">
                <div class="card small hoverable">
                    <div class="card-image">
                        <img class="responsive-img" src="images/customers.jpg">
                    </div>
                    <div class="card-action center-align">
                        <a href="/products" class="blue-text">Products & Services</a>
                    </div>
                </div>
            </div>
            <div class="grid-example col s12 m4 l5">
